<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!--  페이지 내부에서 JSTL태그를 쓰고 싶다면 디렉티브를 통해 taglib 선언을 해야합니다. -->	
...
<%-- c태그 라이브러리의 out을 사용하면 value="출력할값" 형태로 out.println()등을 대체합니다. --%>
<c:out value="name 파라미터로 들어온 값은 ${param.name } 입니다."></c:out>
<% out.println("name 파라미터로 들어온 값은 ${param.name}입니다."); %>
<!--  name파라미터에 이순신이 들어오면 name 파라미터로 들어온 값은 이순신입니다
라고 출력하도록 아래족에 직접 한 번 작성해서 저한테 보내주세요 -->
</c:if>
...
<c:out value="당신이 입력한 값은 ${param.name }입니다."></c:out>
