...
<%
	...
	*/
	...
	// 기본시간은 30분으로 세팅되어있고(디폴트) 바꾼다면 초단위로 바꿀 수 있습니다.
	...
	// 특정한 세션만 삭제시는 .removeAtrribute("세션이름"); 을 이용해 삭제합니다.
	...
	out.println("name_session 삭제 후 : "+ userName + "<br/>");
	 ...
	 // 세션 전체적으로 다 삭제 
	 session.invalidate();
	 out.println("id_session 일괄 삭제후 : " + userId + "<br/>");
	 out.println("JSP 일괄 삭제후 : " + JSP + "<br/>");
